...
const mapDispatchToProps = (dispatch) => ({
  ...
  postFeedback:(firsname,lastname,telnum,email,agree,contactType,message) => dispatch(postFeedback(firsname,lastname,telnum,email,agree,contactType,message))
});
    ...
    const DishWithId = ({match}) => {
      return (
        <div className="container">
          <div className="row">
            <DishDetails dishDetail={this.props.dishes.dishes.filter((dish) => dish.id===parseInt(match.params.dishId,10))[0]}  
