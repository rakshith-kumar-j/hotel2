            ...
            <Navbar dark expand="md">
                <div className="container">
                    ...
                    <NavbarBrand className="mr-auto" href="/">
                        <img height="30" width="41" alt="Ristorante Con Fusion" src="assets/images/logo.png"></img>
                    </NavbarBrand>
                ...
                <ModalBody>
                    <Form onSubmit={this.handleLogin}>
                        ...
                        <FormGroup>
                            ...
                            <Input name="password" id="password" type="password" innerRef={(input => this.password=input)}></Input>
                        </FormGroup>
